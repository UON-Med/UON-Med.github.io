    ...
    var options = {
        ...
        list: {
            ...
            onChooseEvent: function() {
                ...
                new_result += "<a id='cal-link' href='https://calendar.google.com/calendar?cid="+link+"' target='_blank' class='waves-effect waves-light btn tooltipped' data-position='right' data-tooltip='If you don&#39;t get the \"Add calendar\" prompt, try it on a computer.'>"+$("#search-input").val()+"</a>";
